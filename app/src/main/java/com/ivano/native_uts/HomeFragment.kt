...
import com.ivano.native_uts.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val url = "https://ubaya.me/native/160421054/read-cerita.php"
        var stringRequest =StringRequest(Request.Method.POST, url, Response.Listener {
            Log.d("apiresult", it)
